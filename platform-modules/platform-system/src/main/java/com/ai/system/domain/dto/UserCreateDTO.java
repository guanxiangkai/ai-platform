...
public record UserCreateDTO(
        ...
        @Schema(description = "UTF-8原始密码的SHA-1小写十六进制摘要", requiredMode = Schema.RequiredMode.REQUIRED, accessMode = Schema.AccessMode.WRITE_ONLY) @NotBlank(message = "密码摘要不能为空") @Pattern(regexp = PasswordDigestProtocol.DIGEST_REGEX, message = "密码摘要必须为40位小写SHA-1十六进制字符串") @JsonProperty(access = JsonProperty.Access.WRITE_ONLY) String passwordDigest,
    ...
    public String toString() {
        return "UserCreateDTO[username=" + username + ", passwordDigest=[REDACTED]]";
    }
}
